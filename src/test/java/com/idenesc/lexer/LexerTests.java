...
public class LexerTests {
    ...
    public void invalidIdentifier() throws IOException {
    ...
    public void invalidVariable() throws IOException {
    ...
    public void invalidSquareBrackets() throws IOException {
        reloadFile(LexerTests.class.getResourceAsStream("/avroraz/invalidSquareBrackets.txt"));
        iterateTokens();
    }
    
    public void iterateTokens() throws IOException{
